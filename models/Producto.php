<?php
    class Producto extends Conectar{
        ...
        public function insert_producto($cat_id,$prod_nom, $prod_descrip, $prod_cant){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_producto (prod_id, cat_id, prod_nom, prod_descrip, prod_cant, fecha_crea, fecha_modi, fecha_elim, estado) 
                    VALUES 
        ...
        public function update_producto($prod_id,$cat_id, $prod_nom, $prod_descrip, $prod_cant){
            $conectar= parent::conexion();
            parent::set_names();
