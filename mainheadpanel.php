      ...
      <div class="br-header-left">
        ...
        <div class="input-group hidden-xs-down wd-170 transition">
          ...
          <span class="input-group-btn">
            <button class="btn btn-secondary" type="button"><ion-icon name="search-outline"></ion-icon></button>
          </span>
        </div><!-- input-group -->
      </div><!-- br-header-left -->
        ...
        <nav class="nav">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header">
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="../../public/img/img7.jpg" alt="">
                    <div class="media-body">
                      <div>
                        <p>Robert Walker</p>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header">
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="../../public/img/img8.jpg" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="../../public/img/img9.jpg" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media">
                    <img src="../../public/img/img10.jpg" alt="">
                    <div class="media-body">
          ...
          <div class="dropdown">
            <a href="#" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="../../public/img/img1.jpg" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href="#"><img src="../../public/img/img1.jpg" class="wd-80 rounded-circle" alt=""></a>
